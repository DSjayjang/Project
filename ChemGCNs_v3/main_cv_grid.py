...
from utils import cv, cv_gridsearch, evaluation, evaluation_LapPE
...
def main():
    ...
    # ------------------------------------------------------------------ #
    # # LapPE
    # val_losses['LapPE0219'] = cv_gridsearch.grid_search_kfold(dataset, dim_atomic_feat, num_desc_2d, num_desc_3d, param_list, criterion, args.k, args.batch_size, args.epochs, args.seed, args.dataset, collate_fn, model_name = 'LapPE0219')

    # # LapPE
    # val_losses['LapPE0220'] = cv_gridsearch.grid_search_kfold(dataset, dim_atomic_feat, num_desc_2d, num_desc_3d, param_list, criterion, args.k, args.batch_size, args.epochs, args.seed, args.dataset, collate_fn, model_name = 'LapPE0220')

    # # Low rank TF
    val_losses['LapPE0221_total'] = cv_gridsearch.grid_search_kfold(dataset, dim_atomic_feat, num_desc_2d, num_desc_3d, param_list, criterion, args.k, args.batch_size, args.epochs, args.seed, args.dataset, collate_fn, model_name = 'LapPE0221_total')
