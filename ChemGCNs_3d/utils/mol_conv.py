...
def read_dataset_freesolv(file_name):
    ...
    desc = ['NHOHCount', 'SlogP_VSA2', 'SlogP_VSA10', 'NumAromaticRings', 'MaxEStateIndex',
...
def read_dataset_esol(file_name):
    ...
    desc = ['MolLogP', 'MaxAbsPartialCharge', 'MaxEStateIndex', 'SMR_VSA10', 'Kappa2',
...
def read_dataset_lipo(file_name):
    ...
    desc = ['MolLogP', 'fr_COO', 'Ipc', 'fr_sulfonamd', 'PEOE_VSA7',
