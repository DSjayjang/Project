...
# Solubility
def read_dataset_scgas_clear(file_name):
    samples = []
    mol_graphs = []
    data_mat = np.array(pd.read_csv(file_name))
    smiles = data_mat[:, 0]
...
def safe_desc_calc(obj, attr, fn, mol, idx=None, smiles=None):
    try:
        v = fn(mol)
        if v is None or np.isnan(v) or np.isinf(v):
            print(f"❌ NaN/inf 발생! descriptor={attr}, value={v}, smiles={smiles}, idx={idx}")
        return v
    except Exception as e:
        print(f"❌ 예외 발생! descriptor={attr}, smiles={smiles}, idx={idx}, error")
        return float("nan")

def read_dataset_scgas_find(file_name):
    samples = []
    mol_graphs = []
    data_mat = np.array(pd.read_csv(file_name))
    smiles = data_mat[:, 0]
    ...
    descriptor_functions = {
        # --- 1 ~ 122 : 일반 RDKit 디스크립터 ---
        "MaxEStateIndex": dsc.MaxEStateIndex,
        "MinEStateIndex": dsc.MinEStateIndex,
        "MaxAbsEStateIndex": dsc.MaxAbsEStateIndex,
        "MinAbsEStateIndex": dsc.MinAbsEStateIndex,
        "qed": dsc.qed,
        "MolWt": dsc.MolWt,
        "HeavyAtomMolWt": dsc.HeavyAtomMolWt,
        "ExactMolWt": dsc.ExactMolWt,
        "NumValenceElectrons": dsc.NumValenceElectrons,
        "NumRadicalElectrons": dsc.NumRadicalElectrons,
        "MaxPartialCharge": dsc.MaxPartialCharge,
        "MinPartialCharge": dsc.MinPartialCharge,
        "MaxAbsPartialCharge": dsc.MaxAbsPartialCharge,
        "MinAbsPartialCharge": dsc.MinAbsPartialCharge,
        "FpDensityMorgan1": dsc.FpDensityMorgan1,
        "FpDensityMorgan2": dsc.FpDensityMorgan2,
        "FpDensityMorgan3": dsc.FpDensityMorgan3,
        "BCUT2D_MWHI": dsc.BCUT2D_MWHI,
        "BCUT2D_MWLOW": dsc.BCUT2D_MWLOW,
        "BCUT2D_CHGHI": dsc.BCUT2D_CHGHI,
        "BCUT2D_CHGLO": dsc.BCUT2D_CHGLO,
        "BCUT2D_LOGPHI": dsc.BCUT2D_LOGPHI,
        "BCUT2D_LOGPLOW": dsc.BCUT2D_LOGPLOW,
        "BCUT2D_MRHI": dsc.BCUT2D_MRHI,
        "BCUT2D_MRLOW": dsc.BCUT2D_MRLOW,
        "BalabanJ": dsc.BalabanJ,
        "BertzCT": dsc.BertzCT,
        "Chi0": dsc.Chi0,
        "Chi0n": dsc.Chi0n,
        "Chi0v": dsc.Chi0v,
        ...
        "Chi4n": dsc.Chi4n,
        "Chi4v": dsc.Chi4v,
        "HallKierAlpha": dsc.HallKierAlpha,
        "Ipc": dsc.Ipc,
        "Kappa1": dsc.Kappa1,
        "Kappa2": dsc.Kappa2,
        "Kappa3": dsc.Kappa3,
        "LabuteASA": dsc.LabuteASA,
        "PEOE_VSA1": dsc.PEOE_VSA1,
        "PEOE_VSA2": dsc.PEOE_VSA2,
        "PEOE_VSA3": dsc.PEOE_VSA3,
        "PEOE_VSA4": dsc.PEOE_VSA4,
        "PEOE_VSA5": dsc.PEOE_VSA5,
        "PEOE_VSA6": dsc.PEOE_VSA6,
        "PEOE_VSA7": dsc.PEOE_VSA7,
        "PEOE_VSA8": dsc.PEOE_VSA8,
        "PEOE_VSA9": dsc.PEOE_VSA9,
        "PEOE_VSA10": dsc.PEOE_VSA10,
        "PEOE_VSA11": dsc.PEOE_VSA11,
        "PEOE_VSA12": dsc.PEOE_VSA12,
        "PEOE_VSA13": dsc.PEOE_VSA13,
        "PEOE_VSA14": dsc.PEOE_VSA14,
        "SMR_VSA1": dsc.SMR_VSA1,
        "SMR_VSA2": dsc.SMR_VSA2,
        "SMR_VSA3": dsc.SMR_VSA3,
        "SMR_VSA4": dsc.SMR_VSA4,
        "SMR_VSA5": dsc.SMR_VSA5,
        "SMR_VSA6": dsc.SMR_VSA6,
        "SMR_VSA7": dsc.SMR_VSA7,
        "SMR_VSA8": dsc.SMR_VSA8,
        "SMR_VSA9": dsc.SMR_VSA9,
        "SMR_VSA10": dsc.SMR_VSA10,
        "SlogP_VSA1": dsc.SlogP_VSA1,
        "SlogP_VSA2": dsc.SlogP_VSA2,
        "SlogP_VSA3": dsc.SlogP_VSA3,
        "SlogP_VSA4": dsc.SlogP_VSA4,
        "SlogP_VSA5": dsc.SlogP_VSA5,
        "SlogP_VSA6": dsc.SlogP_VSA6,
        "SlogP_VSA7": dsc.SlogP_VSA7,
        "SlogP_VSA8": dsc.SlogP_VSA8,
        "SlogP_VSA9": dsc.SlogP_VSA9,
        "SlogP_VSA10": dsc.SlogP_VSA10,
        "SlogP_VSA11": dsc.SlogP_VSA11,
        "SlogP_VSA12": dsc.SlogP_VSA12,
        "TPSA": dsc.TPSA,
        "EState_VSA1": dsc.EState_VSA1,
        "EState_VSA2": dsc.EState_VSA2,
        "EState_VSA3": dsc.EState_VSA3,
        "EState_VSA4": dsc.EState_VSA4,
        "EState_VSA5": dsc.EState_VSA5,
        "EState_VSA6": dsc.EState_VSA6,
        "EState_VSA7": dsc.EState_VSA7,
        "EState_VSA8": dsc.EState_VSA8,
        "EState_VSA9": dsc.EState_VSA9,
        "EState_VSA10": dsc.EState_VSA10,
        "EState_VSA11": dsc.EState_VSA11,
        "VSA_EState1": dsc.VSA_EState1,
        "VSA_EState2": dsc.VSA_EState2,
        "VSA_EState3": dsc.VSA_EState3,
        "VSA_EState4": dsc.VSA_EState4,
        "VSA_EState5": dsc.VSA_EState5,
        "VSA_EState6": dsc.VSA_EState6,
        "VSA_EState7": dsc.VSA_EState7,
        "VSA_EState8": dsc.VSA_EState8,
        "VSA_EState9": dsc.VSA_EState9,
        "VSA_EState10": dsc.VSA_EState10,
        "FractionCSP3": dsc.FractionCSP3,
        "HeavyAtomCount": dsc.HeavyAtomCount,
        "NHOHCount": dsc.NHOHCount,
        "NOCount": dsc.NOCount,
        "NumAliphaticCarbocycles": dsc.NumAliphaticCarbocycles,
        "NumAliphaticHeterocycles": dsc.NumAliphaticHeterocycles,
        "NumAliphaticRings": dsc.NumAliphaticRings,
        "NumAromaticCarbocycles": dsc.NumAromaticCarbocycles,
        "NumAromaticHeterocycles": dsc.NumAromaticHeterocycles,
        "NumAromaticRings": dsc.NumAromaticRings,
        "NumHAcceptors": dsc.NumHAcceptors,
        "NumHDonors": dsc.NumHDonors,
        "NumHeteroatoms": dsc.NumHeteroatoms,
        "NumRotatableBonds": dsc.NumRotatableBonds,
        "NumSaturatedCarbocycles": dsc.NumSaturatedCarbocycles,
        "NumSaturatedHeterocycles": dsc.NumSaturatedHeterocycles,
        "NumSaturatedRings": dsc.NumSaturatedRings,
        "RingCount": dsc.RingCount,
        "MolLogP": dsc.MolLogP,
        "MolMR": dsc.MolMR,

        # --- 123 ~ 208 : fragment 기반 디스크립터 ---
        "fr_Al_COO": dsc.fr_Al_COO,
        "fr_Al_OH": dsc.fr_Al_OH,
        "fr_Al_OH_noTert": dsc.fr_Al_OH_noTert,
        "fr_ArN": dsc.fr_ArN,
        "fr_Ar_COO": dsc.fr_Ar_COO,
        "fr_Ar_N": dsc.fr_Ar_N,
        "fr_Ar_NH": dsc.fr_Ar_NH,
        "fr_Ar_OH": dsc.fr_Ar_OH,
        "fr_COO": dsc.fr_COO,
        "fr_COO2": dsc.fr_COO2,
        "fr_C_O": dsc.fr_C_O,
        "fr_C_O_noCOO": dsc.fr_C_O_noCOO,
        "fr_C_S": dsc.fr_C_S,
        "fr_HOCCN": dsc.fr_HOCCN,
        "fr_Imine": dsc.fr_Imine,
        "fr_NH0": dsc.fr_NH0,
        "fr_NH1": dsc.fr_NH1,
        "fr_NH2": dsc.fr_NH2,
        "fr_N_O": dsc.fr_N_O,
        "fr_Ndealkylation1": dsc.fr_Ndealkylation1,
        "fr_Ndealkylation2": dsc.fr_Ndealkylation2,
        "fr_Nhpyrrole": dsc.fr_Nhpyrrole,
        "fr_SH": dsc.fr_SH,
        "fr_aldehyde": dsc.fr_aldehyde,
        "fr_alkyl_carbamate": dsc.fr_alkyl_carbamate,
        "fr_alkyl_halide": dsc.fr_alkyl_halide,
        "fr_allylic_oxid": dsc.fr_allylic_oxid,
        "fr_amide": dsc.fr_amide,
        "fr_amidine": dsc.fr_amidine,
        "fr_aniline": dsc.fr_aniline,
        "fr_aryl_methyl": dsc.fr_aryl_methyl,
        "fr_azide": dsc.fr_azide,
        "fr_azo": dsc.fr_azo,
        "fr_barbitur": dsc.fr_barbitur,
        "fr_benzene": dsc.fr_benzene,
        "fr_benzodiazepine": dsc.fr_benzodiazepine,
        "fr_bicyclic": dsc.fr_bicyclic,
        "fr_diazo": dsc.fr_diazo,
        "fr_dihydropyridine": dsc.fr_dihydropyridine,
        "fr_epoxide": dsc.fr_epoxide,
        "fr_ester": dsc.fr_ester,
        "fr_ether": dsc.fr_ether,
        "fr_furan": dsc.fr_furan,
        "fr_guanido": dsc.fr_guanido,
        "fr_halogen": dsc.fr_halogen,
        "fr_hdrzine": dsc.fr_hdrzine,
        "fr_hdrzone": dsc.fr_hdrzone,
        "fr_imidazole": dsc.fr_imidazole,
        "fr_imide": dsc.fr_imide,
        "fr_isocyan": dsc.fr_isocyan,
        "fr_isothiocyan": dsc.fr_isothiocyan,
        "fr_ketone": dsc.fr_ketone,
        "fr_ketone_Topliss": dsc.fr_ketone_Topliss,
        "fr_lactam": dsc.fr_lactam,
        "fr_lactone": dsc.fr_lactone,
        "fr_methoxy": dsc.fr_methoxy,
        "fr_morpholine": dsc.fr_morpholine,
        "fr_nitrile": dsc.fr_nitrile,
        "fr_nitro": dsc.fr_nitro,
        "fr_nitro_arom": dsc.fr_nitro_arom,
        "fr_nitro_arom_nonortho": dsc.fr_nitro_arom_nonortho,
        "fr_nitroso": dsc.fr_nitroso,
        "fr_oxazole": dsc.fr_oxazole,
        "fr_oxime": dsc.fr_oxime,
        "fr_para_hydroxylation": dsc.fr_para_hydroxylation,
        "fr_phenol": dsc.fr_phenol,
        "fr_phenol_noOrthoHbond": dsc.fr_phenol_noOrthoHbond,
        "fr_phos_acid": dsc.fr_phos_acid,
        "fr_phos_ester": dsc.fr_phos_ester,
        "fr_piperdine": dsc.fr_piperdine,
        "fr_piperzine": dsc.fr_piperzine,
        "fr_priamide": dsc.fr_priamide,
        "fr_prisulfonamd": dsc.fr_prisulfonamd,
        "fr_pyridine": dsc.fr_pyridine,
        "fr_quatN": dsc.fr_quatN,
        "fr_sulfide": dsc.fr_sulfide,
        "fr_sulfonamd": dsc.fr_sulfonamd,
        "fr_sulfone": dsc.fr_sulfone,
        "fr_term_acetylene": dsc.fr_term_acetylene,
        "fr_tetrazole": dsc.fr_tetrazole,
        "fr_thiazole": dsc.fr_thiazole,
        "fr_thiocyan": dsc.fr_thiocyan,
        "fr_thiophene": dsc.fr_thiophene,
        "fr_unbrch_alkane": dsc.fr_unbrch_alkane,
        "fr_urea": dsc.fr_urea
    }
    ...
    for i in range(len(data_mat)):
        mol, mol_graph = smiles_to_mol_graph(smiles[i])
        if mol is None or mol_graph is None:
            continue

        for desc_name, fn in descriptor_functions.items():
            value = safe_desc_calc(mol_graph, desc_name, fn, mol, idx=i, smiles=smiles[i])
            setattr(mol_graph, desc_name, value)
