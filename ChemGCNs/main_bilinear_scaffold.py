...
from utils import trainer_scaffold_bilinear
...
def main():
    ...
    test_losses['Backbone_Fusion'] = trainer_scaffold_bilinear.cross_validation(dataset, model_Fusion, criterion, folds, K, BATCH_SIZE, MAX_EPOCHS, trainer_scaffold_bilinear.train_model, trainer_scaffold_bilinear.test_model, descriptors)
