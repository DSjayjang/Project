...
#         self_feats[i, 7] = mol_graph.SlogP_VSA2
#         self_feats[i, 8] = mol_graph.fr_halogen
#         self_feats[i, 9] = mol_graph.VSA_EState6
#         # 11
#         self_feats[i, 10] = mol_graph.SlogP_VSA5
#         self_feats[i, 11] = mol_graph.EState_VSA2
#         self_feats[i, 12] = mol_graph.fr_ether
#         self_feats[i, 13] = mol_graph.MinEStateIndex
#         self_feats[i, 14] = mol_graph.NumAromaticCarbocycles
#         # 16
#         self_feats[i, 15] = mol_graph.fr_benzene
#         self_feats[i, 16] = mol_graph.SlogP_VSA4
#         self_feats[i, 17] = mol_graph.PEOE_VSA7
#         self_feats[i, 18] = mol_graph.SlogP_VSA12
#         self_feats[i, 19] = mol_graph.VSA_EState10
