...
import someday_useful.mol_conv_bilinear_nan as mc
from utils import trainer_bilinear
...
def main():
    ...
    test_losses['KROVEX'] = trainer_bilinear.cross_validation(dataset, model_KROVEX, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer_bilinear.train_model, trainer_bilinear.test_model, descriptors)
