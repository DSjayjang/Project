...
def main():
    ...
    if DATASET_NAME == 'freesolv':
        ...
        from utils.test_mol import mol_collate_freesolv as mcol
    ...
    test_losses['concat_3'] = trainer.cross_validation(dataset, model_concat_3, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, mcol.descriptor_selection_3)
    print('test loss (concat_3): ' + str(test_losses['concat_3']))

    print('--------- concatenation with 5 descriptors ---------')
    test_losses['concat_5'] = trainer.cross_validation(dataset, model_concat_5, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, mcol.descriptor_selection_5)
    print('test loss (concat_5): ' + str(test_losses['concat_5']))

    print('--------- concatenation with 7 descriptors ---------')
    test_losses['concat_7'] = trainer.cross_validation(dataset, model_concat_7, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, mcol.descriptor_selection_7)
    print('test loss (concat_7): ' + str(test_losses['concat_7']))

    print('--------- concatenation with 10 descriptors ---------')
    test_losses['concat_10'] = trainer.cross_validation(dataset, model_concat_10, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, mcol.descriptor_selection_10)
    print('test loss (concat_10): ' + str(test_losses['concat_10']))

    print('--------- concatenation with 20 descriptors ---------')
    test_losses['concat_20'] = trainer.cross_validation(dataset, model_concat_20, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, mcol.descriptor_selection_20)
    print('test loss (concat_20): ' + str(test_losses['concat_20']))

    print('--------- concatenation with descriptor selection ---------')
    test_losses['concat_ds'] = trainer.cross_validation(dataset, model_concat_ds, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, descriptors)
    print('test loss (concat_ds): ' + str(test_losses['concat_ds']))

    #------------------------ kronecker-product + descriptor selection ------------------------#
    print('--------- kronecker-product with 3 descriptors ---------')
    test_losses['kronecker_3'] = trainer.cross_validation(dataset, model_kronecker_3, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, mcol.descriptor_selection_3)
    print('test loss (kronecker_3): ' + str(test_losses['kronecker_3']))

    print('--------- kronecker-product with 5 descriptors ---------')
    test_losses['kronecker_5'] = trainer.cross_validation(dataset, model_kronecker_5, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, mcol.descriptor_selection_5)
    print('test loss (kronecker_5): ' + str(test_losses['kronecker_5']))

    print('--------- kronecker-product with 7 descriptors ---------')
    test_losses['kronecker_7'] = trainer.cross_validation(dataset, model_kronecker_7, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, mcol.descriptor_selection_7)
    print('test loss (kronecker_7): ' + str(test_losses['kronecker_7']))

    print('--------- kronecker-product with 10 descriptors ---------')
    test_losses['kronecker_10'] = trainer.cross_validation(dataset, model_kronecker_10, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, mcol.descriptor_selection_10)
    print('test loss (kronecker_10): ' + str(test_losses['kronecker_10']))

    print('--------- kronecker-product with 20 descriptors ---------')
    test_losses['kronecker_20'] = trainer.cross_validation(dataset, model_kronecker_20, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, mcol.descriptor_selection_20)
    print('test loss (kronecker_20): ' + str(test_losses['kronecker_20']))

    print('--------- kronecker-product with descriptor selection ---------')
    test_losses['KROVEX'] = trainer.cross_validation(dataset, model_KROVEX, criterion, K, BATCH_SIZE, MAX_EPOCHS, trainer.train_emodel, trainer.test_emodel, descriptors)
