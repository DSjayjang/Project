...
def grid_search_kfold(dataset, dim_in, dim_desc_2d,
    ...
    for cfg_id, cfg in enumerate(param_list):
        ...
        for fold, (train_idx, val_idx) in enumerate(kf.split(idx)):
            ...
            model = BAN_grid.Net(
                dim_in=dim_in,
                dim_desc_2d=dim_desc_2d,
                dim_graph=cfg['dim_graph'],
                d_t=cfg['d_t'],
                K=cfg["K"],
                glimpse=cfg["glimpse"],
                dim_out_fc1=cfg["fc1"],
        ...
        # loss plot
        save_path = f'./results/loss/{dataset_name}_{model_name}_{max_epochs}_{num_folds}_{seed}_{criterion}_{cfg["dim_graph"]}_{cfg["d_t"]}_{cfg["K"]}_{cfg["glimpse"]}_{cfg["fc1"]}_{cfg["fc2"]}.png'
        ...
        csv_path = f'./results/se/{dataset_name}_{model_name}_{max_epochs}_{num_folds}_{seed}_{criterion}_{cfg["dim_graph"]}_{cfg["d_t"]}_{cfg["K"]}_{cfg["glimpse"]}_{cfg["fc1"]}_{cfg["fc2"]}.csv'
