...
def main():
    ...
    # # ----------------------------FaBiG_gin ----------------------------- #
    # test_losses['fag_gin'], test_losses['fag_gin_R2'], attention_records = evaluation_viz.evaluation(train_dataset, test_dataset, fag_gin, criterion, desc_list, args.batch_size, args.epochs, collate_fn, args.dataset, args.phase, args.save_model, ckpt_path, model_name='fag_gin')
