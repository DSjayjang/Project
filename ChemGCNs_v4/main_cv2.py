...
from utils import evaluation, evaluation_viz, evaluation_cv
...
def main():
    ...
    # -------------------------- Baseline ------------------------------ #
    # # KROVEX
    test_losses['KROVEX'], test_losses['KROVEX_R2'] = evaluation_cv.evaluation(dataset, KROVEX, criterion, desc_list, args.batch_size, args.epochs, args.seed, args.k, collate_fn, args.dataset, args.phase, args.save_model, ckpt_path, 'KROVEX')
    ...
    # KROVEX GCN 직접 구현
    # test_losses['KROVEX_GCNs'], test_losses['KROVEX_GCNs_R2'] = evaluation_cv.evaluation(dataset, KROVEX_GCNs, criterion, desc_list, args.batch_size, args.epochs, args.seed, args.k, collate_fn, args.dataset, args.phase, args.save_model, ckpt_path, 'KROVEX_GCNs')
    ...
    # # ----------------------------FaBiG ----------------------------- #
    # test_losses['fag'], test_losses['fag_R2'] = evaluation_cv.evaluation(dataset, fag, criterion, desc_list, args.batch_size, args.epochs, args.seed, args.k, collate_fn, args.dataset, args.phase, args.save_model, ckpt_path, 'fag')
