...
def read_dataset_freesolv(file_name):
    ...
    desc = ['MolLogP', 'TPSA', 'NumHAcceptors', 'NumAromaticRings', 'Chi1v',
       'NumHDonors', 'SlogP_VSA2', 'SlogP_VSA12', 'HallKierAlpha',
       'EState_VSA10', 'fr_halogen', 'Chi1n', 'Chi1', 'MaxEStateIndex',
       'MaxAbsEStateIndex', 'SMR_VSA3', 'FractionCSP3', 'SMR_VSA7',
       'MinPartialCharge', 'HeavyAtomCount', 'VSA_EState3',
       'MinAbsPartialCharge', 'SlogP_VSA6', 'Chi3n', 'VSA_EState10']
    
    for feat in desc:
        FeatureNormalization(mol_graphs, feat)

    return samples, desc, smiles_list
...
def read_dataset_esol(file_name):
    ...
    desc = ['MolLogP', 'HeavyAtomMolWt', 'MaxAbsPartialCharge', 'SlogP_VSA6',
       'HallKierAlpha', 'LabuteASA', 'fr_Ar_NH', 'PEOE_VSA6',
       'FpDensityMorgan1', 'NumAromaticCarbocycles', 'TPSA', 'fr_benzene',
       'MaxEStateIndex', 'MaxAbsEStateIndex', 'fr_NH1', 'EState_VSA5',
       'EState_VSA7', 'fr_Ar_OH', 'Chi0', 'EState_VSA8', 'BertzCT']
...
def read_dataset_lipo(file_name):
    ...
    desc = ['MolLogP', 'fr_COO', 'PEOE_VSA7', 'Ipc', 'fr_sulfonamd', 'PEOE_VSA13',
       'SMR_VSA10', 'SlogP_VSA10', 'NumHDonors', 'fr_unbrch_alkane',
       'fr_guanido', 'PEOE_VSA12', 'FpDensityMorgan1', 'fr_HOCCN',
       'NumSaturatedCarbocycles', 'VSA_EState5', 'fr_sulfide', 'fr_piperdine',
       'fr_amidine', 'BalabanJ', 'NHOHCount', 'NumAromaticHeterocycles',
       'NumAromaticRings', 'MinEStateIndex']
    for feat in desc:
        FeatureNormalization(mol_graphs, feat)
...
def read_dataset_vp(file_name):
    ...
    desc =  ['MolMR', 'TPSA', 'fr_halogen', 'SlogP_VSA12', 'RingCount',
...
def read_dataset_solubility(file_name):
    ...
    desc = ['Chi1v', 'Chi1', 'SlogP_VSA2', 'HallKierAlpha', 'PEOE_VSA6',
...
# Full Descriptors
def read_dataset_full(file_name):
    samples = []
    mol_graphs = []
    data_mat = np.array(pd.read_csv(file_name))
    smiles = data_mat[:, 0]
