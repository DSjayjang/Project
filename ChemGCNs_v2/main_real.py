...
from utils import cv, trainer, trainer_3d, trainer_3d_split_aux, evaluation, evaluation_aux
...
def main():
    ...
    # -------------------------- Cross Attention + TFN ------------------------------ #
    test_losses['md_CrossAttn_TFN'], test_losses['md_CrossAttn_TFN_R2'] = evaluation.full_train_and_test(train_dataset, test_dataset, md_CrossAttn_TFN, criterion, BATCH_SIZE, MAX_EPOCHS, collate_fn, model_name='md_CrossAttn_TFN')
    print(f'Final test | loss: ' + str(test_losses['md_CrossAttn_TFN']) + '| R2: ' + str(test_losses['md_CrossAttn_TFN_R2']))
