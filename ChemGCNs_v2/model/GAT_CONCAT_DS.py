...
class concat_5(nn.Module):
    def __init__(self, dim_in, dim_out, num_heads, dim_self_feat):
        super(concat_5, self).__init__()
...
class concat_7(nn.Module):
    def __init__(self, dim_in, dim_out, num_heads, dim_self_feat):
        super(concat_7, self).__init__()
...
class concat_10(nn.Module):
    def __init__(self, dim_in, dim_out, num_heads, dim_self_feat):
        super(concat_10, self).__init__()
...
class concat_20(nn.Module):
    def __init__(self, dim_in, dim_out, num_heads, dim_self_feat):
        super(concat_20, self).__init__()
